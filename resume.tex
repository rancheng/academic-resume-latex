...
\shorterSection{\textcolor{titleblue}{Publications}}
  ...
  \small
        ...
        \item{Deep Monocular Visual Odometry with Direct Method, \textbf{R. Cheng}, D. Meger, G. Dudek \textbf{CVPR 2020} \href{https://rancheng.github.io/deep-schur-complement/}{\textcolor{linkblue}{preprint}}}
        \vspace{-5pt}
        \item{Robust Off-road Robotics Visual Navigation with Back-Projection Learning, \textbf{R. Cheng}, G. Dudek, D.Meger, \textbf{ICRA 2020}, \href{https://github.com/rancheng/rancheng.github.io/raw/master/docs/icra2019_auto_driving.pdf}{\textcolor{linkblue}{preprint}}}
        \vspace{-5pt}
        
        \item{Abstraction Augmentation for Deep Reinforcement Learning, \textbf{R. Cheng}, G. Dudek, D. Meger \textbf{CoRL 2019}, \href{https://github.com/rancheng/rancheng.github.io/raw/master/docs/CoRL2019(1).pdf}{\textcolor{linkblue}{paper}}}
        \vspace{-5pt}
        ...
        \item{Navigation in the Service of Enhanced Pose Estimation, Travis Manderson, \textbf{Ran Cheng}, David Meger and Gregory Dudek, \textbf{ISER 2018}, \href{https://github.com/rancheng/rancheng.github.io/raw/master/docs/iser2018_aqua_path_learning.pdf}{\textcolor{linkblue}{paper}}}
        \vspace{-5pt}
        \item{Vision-Based Autonomous Underwater Swimming in Dense Coral for Combined Collision Avoidance and Target Selection, T. Manderson, \textbf{R. Cheng}, D. Meger, G. Dudek, \textbf{IROS 2018}, \href{https://github.com/rancheng/rancheng.github.io/raw/master/docs/iros2018_aqua_path_learning.pdf}{\textcolor{linkblue}{paper}}}
  \resumeSubHeadingListEnd
%-------------------------------------------
\end{document}
